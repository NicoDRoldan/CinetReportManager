namespace AvisoReporte.Models.Comprobante
{
    public class OrdenDePagoModel
    {
        ...
        public List<string>? EmailsProveedores { get; set; } = new List<string>();
        public virtual ICollection<LiquidacionModel> Liquidaciones { get; set; } = new List<LiquidacionModel>();
